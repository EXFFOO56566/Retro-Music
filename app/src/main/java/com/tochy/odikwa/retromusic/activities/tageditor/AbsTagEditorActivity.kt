package com.tochy.odikwa.retromusic.activities.tageditor
...
abstract class AbsTagEditorActivity : AbsBaseActivity() {
    ...
    private fun setUpImageView() {
        loadCurrentImage()
        items = listOf(
            getString(com.tochy.odikwa.retromusic.R.string.pick_from_local_storage),
            getString(com.tochy.odikwa.retromusic.R.string.web_search),
            getString(com.tochy.odikwa.retromusic.R.string.remove_cover)
        )
