...
package com.tochy.odikwa.retromusic.preferences
...
import com.tochy.odikwa.appthemehelper.common.prefs.supportv7.ATEDialogPreference
import com.tochy.odikwa.retromusic.R
import com.tochy.odikwa.retromusic.dialogs.BlacklistFolderChooserDialog
import com.tochy.odikwa.retromusic.extensions.colorControlNormal
import com.tochy.odikwa.retromusic.providers.BlacklistStore
        ...
        return MaterialDialog(requireContext()).show {
            ...
            neutralButton(text = getString(R.string.clear_action)) {
                MaterialDialog(requireContext()).show {
                    title(com.tochy.odikwa.retromusic.R.string.clear_blacklist)
                    message(com.tochy.odikwa.retromusic.R.string.do_you_want_to_clear_the_blacklist)
                    cornerRadius(PreferenceUtil.getInstance(requireContext()).dialogCorner)
                    positiveButton(com.tochy.odikwa.retromusic.R.string.clear_action) {
            ...
            listItems(items = paths, waitForPositiveButton = false) { _, _, text ->
                MaterialDialog(requireContext()).show {
                    cornerRadius(PreferenceUtil.getInstance(requireContext()).dialogCorner)
                    title(com.tochy.odikwa.retromusic.R.string.remove_from_blacklist)
                    message(
                    ...
                    positiveButton(com.tochy.odikwa.retromusic.R.string.remove_action) {
